...
1.  Intro to Bayesian statistics: review (23-Feb-23)
2.  Intro to MCMC: analysis of MCMC draws (02-Mar-23)
3.  Intro to MCMC: using *brms* (09-Mar-23)
4.  Bayesian linear models: simple and polynomial regression, multiple regression, categorical predictors (23-Mar-23)
5.  Bayesian linear models: interactions, fitting factorial ANOVA (30-Mar-23)
6.  Bayesian generalized linear models (20-Apr-23)
7.  Bayesian multilevel models (04-May-23)
8.  Final exam (11-May-23)

## Assessment methods:

-   Final exam (11-May-23)
...
-   On page 47 you will find 2 practice tasks: 2M1 and 2M2. Prepare responses to this tasks.
-   Send the solution as an .R file.
-   **Deadline:** 2-Mar-23 12:00PM
