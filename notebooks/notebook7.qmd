...
In classical/Frequentist approach to multilevel modeling, we would expect to have at least 30 observations within each cluster (i.e., voivodeship) and more that 20 clusters (voivovedships). While the first condition seems to be satisfied for most cases, the second is impossible to meet. 
